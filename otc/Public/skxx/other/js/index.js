...
$(function(){
          // var speend=20;
          // var liWidth =$('.new-box-scroll ul li').width();
          // var liLength= $('.new-box-scroll ul li').length;
          // var height1 = $('.xg-min').width()
          // console.log(liWidth)
          
        //   $('.new-wrapper ul').css('width',liWidth*liLength);
        //   var ulWidth=$('.new-wrapper ul').width();
        //   var ulLength= $('.new-wrapper ul').length;
        //   $('.new_box_816_center').css('width',ulWidth*ulLength)
        // document.getElementById("indexMarketListsTopClone").innerHTML=document.getElementById("indexMarketListsTop").innerHTML;
        // function done(){
        //     if(document.getElementById("indexMarketListsTop").offsetWidth-document.getElementById("indexMarketListsTopBox").scrollLeft<=0){
        //         document.getElementById("indexMarketListsTopBox").scrollLeft-=document.getElementById("indexMarketListsTop").offsetWidth;
        //         console.log(2)
        //     }else{
        //         console.log(1)
        //         document.getElementById("indexMarketListsTopBox").scrollLeft++;
        //     }
        // }
        // var flag=setInterval(done,speend);
        // document.getElementById("indexMarketListsTopBox").onmouseover=function(){clearInterval(flag)}
        // document.getElementById("indexMarketListsTopBox").onmouseout=function(){flag=setInterval(done,speend);}
})
