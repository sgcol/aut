        ...
        <div class="data-table table-striped">
            ...
            <table class="">
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo['buyname']); ?></td>

                            <td><?php echo ($vo['type']?'出售':'购买'); ?></td>
                            ...
                            <td><?php echo (addtime($vo["addtime"])); ?></td>
                                ...
                                <td>
                                    <?php switch($vo["status"]): case "0": ?>未付款<?php break;?>
                                    <?php case "1": ?>已付款<?php break;?>
                                    <?php case "2": ?>已释放<?php break;?>
                                    <?php case "3": ?>交易完成<?php break;?>
                                    <?php case "4": ?>交易取消<?php break;?>
                                    <?php case "5": ?>申诉中<?php break;?>
                                    <?php case "6": ?>订单超时<?php break; endswitch;?>
                                </td>

                            <td>
                                <a href="<?php echo U('Trade/chatlog?id='.$vo['id']);?>" class=" btn btn-primary btn-xs">查看聊天记录</a>
                                <?php if($vo["status"] == 5): ?><div class="dropdown">
                                        <button class="btn btn-primary btn-xs">修改状态</button>
                                        <div class="dropdown-content">
                                            <a href="<?php echo U('Trade/reset?id='.$vo['id']);?>">重启交易</a>
                                            <a href="<?php echo U('Trade/quit?id='.$vo['id']);?>">取消交易</a>
                                            <a href="<?php echo U('Trade/end?id='.$vo['id']);?>">完成交易</a>
                                        </div>
                                    </div><?php endif; ?>
